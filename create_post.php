...
if (!empty($_POST)) {
    ...
    if (empty($_POST['content']) || strlen($_POST['content']) <= 3) {
        $errors['content'] = "Veillez saisir la description correct pour votre post";
    }
    ...
    if (!empty($_POST['content'])) {
        ...
        $query = $pdo->prepare(
            'INSERT INTO posts(id,image,content,date_creation,user_id) VALUES(null,?,?,NOW(),?)'
        );
                ...
                <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <div class="col-sm-9">
                                <label class="form-label">
                                    Description de votre fichier : </label>
                                <textarea class="form-control" name="content" id="editor1" style="height:200px;"></textarea>
                            </div>
                        </div>
